...
class Setup2Page extends Component{
    ...
    timeTable() {
        ...
        return(
            <>
            <TimeSlotTable ref = {this.currentTable} type = {state.type} dates={days} showTimeSlot={showTimeSlot} minStartTime={minStart} perferred = {false} isInputTable = {true} events = {[]}
